...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP(
        ...
        LSFT,    Z,    X,   C,   V,   B,      DEL,    HOME,  END,             PGUP,        PGDN,  DEL,      N,    M, COMM,  DOT, SLSH, RSFT,  \
              NUBS, LEFT,RGHT, FN0,          BSPC,     DEL, LALT,             RALT,         ENT,  SPC,          FN0,   UP, DOWN, FN14, \
						            LCTL,             RCTL ),
    /* 1: media keys */
    KEYMAP(
        ...
        TRNS,     FN22,     GRV,TRNS,TRNS,        FN20,TRNS,TRNS,TRNS,     TRNS,TRNS,TRNS,KP_ASTERISK,TRNS,TRNS,TRNS,FN23,TRNS,     \
                  TRNS,    TRNS,TRNS,TRNS,             TRNS,TRNS,TRNS,     TRNS,TRNS,TRNS,       TRNS,TRNS,TRNS,FN21,          \
				 		                 TRNS,     TRNS ),
};
